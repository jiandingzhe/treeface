...
{
    PackageManager::getInstance()->add_package(resources::resources1_zip, resources::resources1_zipSize, PackageManager::OVERWRITE);
    ...
    PackageManager::getInstance()->add_package(resources::resources2_zip, resources::resources2_zipSize, PackageManager::OVERWRITE);
    OK(PackageManager::getInstance()->has_resource("foo"));
    {
        InputStream* stream = PackageManager::getInstance()->get_item_stream("foo");
        OK(stream);
