...
void TestFramework::content()
{
    ...
    RefCountHolder<Geometry> geo_colored = geo_mgr->get_geometry( "geom_colored.json" );
    RefCountHolder<Geometry> geo_cube    = geo_mgr->get_geometry( "geom_cube.json" );
    OK( geo_colored != nullptr );
    OK( geo_cube != nullptr );
    ...
    Material* mat_vert_color = mat_mgr->get_material( "material_vert_color.json" );
    OK( mat1 != nullptr );
    OK( mat2 != nullptr );
    OK( mat_vert_color != nullptr );
