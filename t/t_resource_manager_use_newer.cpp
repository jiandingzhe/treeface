...
{
    ResourceManager::getInstance()->add_package(resources::resources1_zip, resources::resources1_zipSize, ResourceManager::USE_NEWER);
    ...
    ResourceManager::getInstance()->add_package(resources::resources2_zip, resources::resources2_zipSize, ResourceManager::USE_NEWER);
    OK(ResourceManager::getInstance()->has_resource("foo"));
    {
        InputStream* stream = ResourceManager::getInstance()->get_resource("foo");
        int64 size = stream->getTotalLength();
