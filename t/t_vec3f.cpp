...
void TestFramework::content()
{
    ...
    {
        Vec3f vec = 12.34f * Vec3f( -111.222f, -333.444f, 555.666f );
        IS_EPSILON( vec.x, -1372.479f );
        IS_EPSILON( vec.y, -4114.699f );
        IS_EPSILON( vec.z, 6856.918f );
    }
    ...
    {
        Vec3f vec( 234.568f, -112.423f, 998.241f );
        Vec3f vec_neg = -vec;
        IS_EPSILON( vec_neg.x, -234.568f );
        IS_EPSILON( vec_neg.y, 112.423f );
        IS_EPSILON( vec_neg.z, -998.241f );
    }
