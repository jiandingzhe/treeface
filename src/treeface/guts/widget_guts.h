...
typedef treecore::HashMap<treecore::Identifier, treecore::RefCountHolder<EventArray> > EventMap;

struct Widget::Guts
{
    typedef treecore::Array<Widget::Guts*>                                                     WidgetRawArray;
    typedef treecore::HashMap<treecore::Identifier, treecore::RefCountHolder<WidgetRawArray> > RespWidgetMap;
    ...
    void recur_remove_resp_parent( const treecore::Identifier& ev_name, Guts* to_be_removed ) noexcept;

    void recur_remove_resp_child( const treecore::Identifier& ev_name, Guts* to_be_removed ) noexcept;
